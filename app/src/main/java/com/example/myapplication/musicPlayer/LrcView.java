...
public class LrcView extends View {
    ...
    private void inflateAttributes(AttributeSet attrs) {
        ...
        float mTextSize = ta.getDimension(R.styleable.Lrc_textSize, 50.0f);
...
//				mCurrentLine = i <= 1 ? 0 : i - 1;
    ...
    public void setLrcPath(String path) {
        ...
        try {
            reader = new BufferedReader(new InputStreamReader(new FileInputStream(file),charsetDetect(path)));
