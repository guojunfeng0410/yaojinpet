package com.example.myapplication.slidinguppanel;
...
class ViewDragHelper {
     ...
     * @return a new ViewDragHelper instance
     */
    static ViewDragHelper create(ViewGroup forParent, float sensitivity, Interpolator interpolator, Callback cb) {
     ...
     * @see #EDGE_BOTTOM
     */
    private void setEdgeTrackingEnabled(int edgeFlags) {
